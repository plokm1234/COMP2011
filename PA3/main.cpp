...
void task4(const string &path)
{
    ...
    cout << "[Example: selections.]" << endl;
    {
        ...
        select_and_print(canvas->height, canvas->width+1);
    }
...
int main()
{
    ...
    // task1("/mnt/c/Users/user/Desktop/lab/PA3/example/input/task1.txt");
    // task2("/mnt/c/Users/user/Desktop/lab/PA3/example/input/task2.txt");
     task3("/mnt/c/Users/user/Desktop/lab/PA3/example/input/task3.txt");
    // task4("/mnt/c/Users/user/Desktop/lab/PA3/example/input/task4.txt");
    return 0;
}
